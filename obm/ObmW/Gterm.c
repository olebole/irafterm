...
static int refresh_source();
static int refresh_destination(), get_rects(), get_regions();
static void scale_zoom(), scale_intzoom(), scale_boxcar();
static void lw_convolve(), bx_boxcar(), bx_extract(), bx_interp();
static int mf_getpixel();
static void mf_getinten();
static void scale_lowpass(), scale_nearest(), scale_bilinear();
static void save_mapping();
static void load_mapping(), get_pixel_mapping();
static void free_mapping(), update_mapping();
